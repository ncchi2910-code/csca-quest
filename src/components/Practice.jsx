...
export default function Practice({ pool, initialTopic = "all", lang, onToggleLang, applyAnswer, onExit }) {
  const t = UI[lang];
  ...
  function pick(i) {
    ...
    const res = applyAnswer({ topic: q.topic, isCorrect: correct, xpGained: xp, maxCombo: nextCombo });
